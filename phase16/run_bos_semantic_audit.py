#!/usr/bin/env python3
"""Run the development-only BOS semantic / market-structure audit."""
...
from phase16.bos_semantic_audit import run_bos_semantic_audit
...
def main() -> int:
    ...
    parser.add_argument("--output", default="phase16/results/bos_semantic_audit")
