#!/usr/bin/env python3
"""Run the development-only CRT trade-archetype decomposition."""
...
from phase16.trade_archetype_decomposition import run_trade_archetype_decomposition
...
def main() -> int:
    ...
    parser.add_argument("--output", default="phase16/results/trade_archetype_decomposition")
    ...
    result = run_trade_archetype_decomposition(
        data,
