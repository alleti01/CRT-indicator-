#!/usr/bin/env python3
"""Run the SEQUENTIAL_BOS architecture comparison study."""
...
from phase16.sequential_bos import run_comparison_study
...
def main() -> int:
    ...
    parser.add_argument("--output", default="phase16/results/sequential_bos")
