# Start Phase74 shadow bot with signal validation (virtual trades + entry gates)
...
Write-Host "Starting validation shadow bot (virtual trades, pass-chase enabled)..." -ForegroundColor Cyan
