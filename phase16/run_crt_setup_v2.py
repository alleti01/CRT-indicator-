#!/usr/bin/env python3
"""Run CRT Setup V2 predefined experiment."""
...
from phase16.crt_setup_v2 import run_crt_setup_v2_study
...
def main() -> int:
    ...
    parser.add_argument("--output", default="phase16/results/crt_setup_v2")
